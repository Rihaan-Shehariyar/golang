...
const (
	...
	LoginService_GetProfile_FullMethodName = "/proto.LoginService/GetProfile"
)
...
type LoginServiceClient interface {
	...
	GetProfile(ctx context.Context, in *ProfileRequet, opts ...grpc.CallOption) (*ProfileResponse, error)
}
...
func (c *loginServiceClient) GetProfile(ctx context.Context, in *ProfileRequet, opts ...grpc.CallOption) (*ProfileResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProfileResponse)
	err := c.cc.Invoke(ctx, LoginService_GetProfile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LoginServiceServer interface {
	...
	GetProfile(context.Context, *ProfileRequet) (*ProfileResponse, error)
...
func (UnimplementedLoginServiceServer) GetProfile(context.Context, *ProfileRequet) (*ProfileResponse, error) {
...
func _LoginService_GetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LoginService_GetProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).GetProfile(ctx, req.(*ProfileRequet))
	}
	return interceptor(ctx, in, info, handler)
}
