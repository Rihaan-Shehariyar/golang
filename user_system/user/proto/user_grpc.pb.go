...
type UserServiceClient interface {
	...
	ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListUsersResponse, error)
}
...
func (c *userServiceClient) ListUser(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*ListUsersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type UserServiceServer interface {
	...
	ListUser(context.Context, *Empty) (*ListUsersResponse, error)
...
func (UnimplementedUserServiceServer) ListUser(context.Context, *Empty) (*ListUsersResponse, error) {
