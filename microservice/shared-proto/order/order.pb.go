...
const file_order_proto_rawDesc = "" +
	...
	"\aproduct\x18\x03 \x01(\tR\aproduct\"G\n" +
	...
	"\rOrderResponse\x12\"\n" +
	"\x05order\x18\x01 \x01(\v2\f.order.OrderR\x05order2\x88\x01\n" +
	"\fOrderService\x12>\n" +
	"\vCreateOrder\x12\x19.order.CreateOrderRequest\x1a\x14.order.OrderResponse\x128\n" +
	"\bGetOrder\x12\x16.order.GetOrderRequest\x1a\x14.order.OrderResponseB\x14Z\x12shared-proto/orderb\x06proto3"
...
var file_order_proto_depIdxs = []int32{
	...
	3, // 4: order.OrderService.GetOrder:output_type -> order.OrderResponse
